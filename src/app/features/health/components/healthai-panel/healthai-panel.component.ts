...
@Component({
  selector: 'app-healthai-panel',
  standalone: true,
  imports: [CommonModule, FormsModule, MarkdownToHtmlPipe],
  templateUrl: './healthai-panel.component.html',
  styleUrl: './healthai-panel.component.css'
})
export class HealthAIPanelComponent implements OnInit {
  ...
  loadAvailableFeatures() {
    this.aiService.getAvailableFeatures().subscribe({
      next: (data) => console.log('HealthAI Features Available:', data),
